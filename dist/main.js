...
function update(time) {
    ...
    console.log({ time: time, lastTime: lastTime, delta: time - lastTime });
    if (lastTime == null) {
        lastTime = -1;
        window.requestAnimationFrame(update);
        return;
